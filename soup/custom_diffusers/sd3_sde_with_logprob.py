...
def sde_step_with_logprob(
    ...
    return_dt: Optional[bool] = False,
    variance_noise: Optional[torch.FloatTensor] = None,
    num_sample_per_step: int=1
):
    """
    ...
    if return_dt:
        return prev_sample, log_prob, prev_sample_mean, std_dev_t, dt, variance_noise
    return prev_sample, log_prob, prev_sample_mean, std_dev_t, variance_noise